  ...
  const loginLogic = async () => {
    ...
    try {
      ...
      if (response.status==200) {
        ...
        //get the user data and verify the token
        // const decoded = jwtDecode(process.env.ACCESS_TOKEN_SECRET);
        // const decoded = JWT.decode(response.data.token, 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ.SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c');
